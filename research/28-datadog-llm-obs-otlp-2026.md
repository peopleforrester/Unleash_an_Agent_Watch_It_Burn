...
**The current enum (authoritative — `opentelemetry-util-genai` + Google ADK doc):**
| Value | Behavior |
|---|---|
...
works but gives no config. **This is the single item I could NOT fully resolve from docs — flagged.**
