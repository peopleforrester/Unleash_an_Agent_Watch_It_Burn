...
1. MVP: Michael's existing telemetry in one Datadog account, visible in the UI — proves Datadog works; locks cross-cutting decisions (collector shape, UST vocabulary, account model)
