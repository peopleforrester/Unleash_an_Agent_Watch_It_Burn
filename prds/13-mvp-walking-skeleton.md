...
4. Check the evil-mcp-shim deployment manifest (in `beats/03-bad-mcp-excessive-agency/evil-mcp-shim/` or its gitops reference). Add or correct `OTEL_RESOURCE_ATTRIBUTES` for `evil-mcp-shim`.
