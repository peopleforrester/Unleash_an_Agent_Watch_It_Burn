...
fail=0
for t in test_cost_counter.py test_proxy_guards.py test_beat3_mcp.py test_agent_hitl.py test_observability.py test_takeaways.py test_verify_harness.py test_chat_ui.py test_mesh.py test_exfil_game.py test_stream.py test_dns.py test_kube_safety.py test_forkbomb_defense.py test_egress.py test_villain_app.py test_customer_stream.py test_image_signing.py; do
    printf '\n== %s ==\n' "${t}"
