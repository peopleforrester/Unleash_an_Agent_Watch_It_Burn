...
fail=0
for t in test_cost_counter.py test_proxy_guards.py test_beat3_mcp.py test_agent_hitl.py test_observability.py test_takeaways.py test_verify_harness.py test_chat_ui.py test_mesh.py test_exfil_game.py test_stream.py; do
    printf '\n== %s ==\n' "${t}"
