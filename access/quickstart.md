...
- `challenges/01-cncf-wall/`: unleash the agent on the platform.
- `challenges/02-sanitization/`: what goes in, what comes out.
- `challenges/03-bad-mcp-excessive-agency/`: when the agent's tools turn on it.
